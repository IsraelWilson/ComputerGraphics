...
#The input tot his file is the image and a name for the image

def main( image, name ): #finds teh number of pixels in the image
    ...
    #Write header information tp PPM file

    f.write( 'P3\n' )
    f.write( '#Created by Israel S.J. Wilson\n' )
    x = str( image[ 0 ].x )
    y = str( image[ 0 ].y )
    temp = x + s + y + n
    f.write( temp )
